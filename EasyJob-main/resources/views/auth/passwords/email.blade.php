                        ...
                        <div class="auth-form-wrap pt-xl-0 pt-70">
                            <div class="auth-form w-xl-30 w-sm-50 w-100">
                                ...
                                <form method="POST" action="{{ route('password.email') }}">
                                    ...
                                    <p class="mb-30 text-center">سنقوم بإرسال رابط إعادة تعيين كلمة المرور على إيميلك</p>
                                    ...
                                    <button class="btn btn-primary btn-block mb-20" type="submit">{{ __('Send Password Reset Link') }}</button>
