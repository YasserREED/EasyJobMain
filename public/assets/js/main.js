  ...
  --------------------------------------------------------------*/
    ...
    function menuFunction() {
        ...
        $(".st-dropdown-btn").on("click", function () {
            $(this)
                .siblings("ul, .st-megamenu-in, .st-vertical-megamenu-in")
                .slideToggle("slow");
            $(this).toggleClass("st-active");
        });
        ...
        $(".st-sub-megamenu-list li").on({
            mouseenter: function () {
                ...
                var index = $this
                    .parent()
                    .parent()
                    .find(".st-sub-megamenu-list li")
                    .index(this);
                $this
                    .closest(".st-megamenu-in")
                    .find(".st-sub-megamenu-in.active")
                    .fadeOut(200, function () {
                        $(this).removeClass("active");
                        $this
                            .closest(".st-megamenu-in")
                            .find(".st-sub-megamenu-in")
                            .eq(index)
                            .fadeIn(200, function () {
                                megaTabEnd = 0;
                                $(this).addClass("active");
    ...
    function scrollFunction() {
        ...
        if (scroll >= 10) {
            ...
            $(
                ".st-sticky-menu .st-desktop-nav .st-vertical-nav-list"
            ).slideUp();
    ...
    function owlCarouselSetup() {
        if ($.exists(".st-hero-slider1")) {
            ...
            $(".st-hero-slider1").owlCarousel({
                ...
                nav: true,
                navText: [
                    '<i class="flaticon-left"></i>PREV',
                    'NEXT<i class="flaticon-right"></i>',
                ],
                dots: false,
                autoplay: false,
  ...
  --------------------------------------------------------------*/
    function mapBar() {
        $(".st-map-bar").on("click", function () {
            $(this)
                .toggleClass("st-bar-active")
                .siblings(".st-map-wrpa")
                .slideToggle();
        });
    }
